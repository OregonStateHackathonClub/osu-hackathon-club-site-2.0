...
function Faq() {
    ...
    return (
        ...
        <div className="infobody">
            <h2> What is this hackathon all about?</h2>
                <p> 
                    ...
                    inclusive of everybody, and fun! In this hackathon, you are not required or encouraged to 
                    forego sleep, work, time with your family, or etc to participate. You are encouraged to make 
                    the best product you can in the time alotted. You are encouraged to learn and add skills to 
                    your repetoire. And you are encouraged to have a good time doing it!
                </p>
        </div>
        ...
        <div className="infobody">
            <h2> I am new to coding. can/should I still participate? 👾</h2>
                <p> 
                    In short, YES! No prior experience is necessary to compete in this event. 
                    In fact, there is a separate prize for teams of entirely new students to compete for. 
