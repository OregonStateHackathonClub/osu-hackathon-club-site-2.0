    ...
    return (
        <>
            ...
            <div className="infobody">
                ...
                {/* Update Devpost Link Each Hackathon */}
                <p>Use <button className="joinclubbuttons"><a href="https://beaver-hacks-spring-2023.devpost.com/" target="_blank" rel="noreferrer noopener">DevPost</a></button>, <button className="joinclubbuttons"><a href="https://discord.gg/pCesGNGjPc" target="_blank" rel="noreferrer noopener">Discord</a></button>, or <button className="joinclubbuttons"><a href="https://osu-hackathon.slack.com/" target="_blank" rel="noreferrer noopener">Slack</a></button> to find teammates.</p>
            </div>
        </>
    );
}
