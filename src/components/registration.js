    ...
    return (
        <>
            ...
            <div className="infobody">
                ...
                <p>Please fill out the registration form <button className="joinclubbuttons"><a href="https://docs.google.com/forms/d/e/1FAIpQLSfR5e-HokAUlhm5e7kltM0cM23Bprycbkk_o4tupGdFckPPkg/viewform?usp=sf_link" target="_blank" rel="noreferrer noopener"> Google Form </a></button></p>
            </div>
        </>
    );
}
